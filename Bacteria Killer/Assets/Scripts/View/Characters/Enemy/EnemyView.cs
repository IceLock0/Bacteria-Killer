...
namespace View.Characters.Enemy
{
    ...
    public class EnemyView : CharacterView
    {
        ...
        public void InitializeByFabric(EnemyConfig enemyConfig)
        {
            ...
            _enemyPresenter = new EnemyPresenter(UpdaterService, _enemyConfig, Rigidobdy, _playerTransformProviderService, transform, HpView.Presenter, DamageableComponent);
